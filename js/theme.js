...
function onHover_2()
{
    $("#serv__icon1").attr('src','assets/imgs/icons/03.png');
}

function offHover_2()
{
    $("#serv__icon1").attr('src','assets/imgs/icons/04.png');
}

function onHover_1()
{
    $("#serv__icon2").attr('src','assets/imgs/icons/01.png');
}

function offHover_1()
{
    $("#serv__icon2").attr('src','assets/imgs/icons/02.png');
}

function onHover_3()
{
    $("#serv__icon3").attr('src','assets/imgs/icons/06.png');
}

function offHover_3()
{
    $("#serv__icon3").attr('src','assets/imgs/icons/05.png');
}
...
contactForm.addEventListener ('submit', (e)=>{
    ...
    let formData = {
        text:text.value,
		email: email.value,
		form_message: form_message.value
	}
